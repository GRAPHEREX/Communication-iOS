...
extension StorageServiceProtos_AccountRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularBoolField(value: &self.noteToSelfArchived) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.readReceipts) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.sealedSenderIndicators) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self.typingIndicators) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self.proxiedLinkPreviews) }()
      case 10: try { try decoder.decodeSingularBoolField(value: &self.noteToSelfMarkedUnread) }()
      case 11: try { try decoder.decodeSingularBoolField(value: &self.linkPreviews) }()
      case 12: try { try decoder.decodeSingularEnumField(value: &self.phoneNumberSharingMode) }()
      case 13: try { try decoder.decodeSingularBoolField(value: &self.notDiscoverableByPhoneNumber) }()
      case 14: try { try decoder.decodeRepeatedMessageField(value: &self.pinnedConversations) }()
      case 15: try { try decoder.decodeSingularBoolField(value: &self.preferContactAvatars) }()
      default: break
      }
    }
  }
