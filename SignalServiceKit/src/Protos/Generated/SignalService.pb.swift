...
struct SignalServiceProtos_CallMessage {
  ...
  var multiRing: Bool {
    get {return _storage._multiRing ?? false}
    set {_uniqueStorage()._multiRing = newValue}
  }
  /// Returns true if `multiRing` has been explicitly set.
  var hasMultiRing: Bool {return _storage._multiRing != nil}
  /// Clears the value of `multiRing`. Subsequent reads from it will return its default value.
  mutating func clearMultiRing() {_uniqueStorage()._multiRing = nil}
...
struct SignalServiceProtos_DataMessage {
  ...
  struct Reaction {
    ...
    var targetAuthorUuid: String {
      get {return _targetAuthorUuid ?? String()}
      set {_targetAuthorUuid = newValue}
    }
    /// Returns true if `targetAuthorUuid` has been explicitly set.
    var hasTargetAuthorUuid: Bool {return self._targetAuthorUuid != nil}
    /// Clears the value of `targetAuthorUuid`. Subsequent reads from it will return its default value.
    mutating func clearTargetAuthorUuid() {self._targetAuthorUuid = nil}
    ...
    fileprivate var _targetAuthorUuid: String? = nil
...
struct SignalServiceProtos_PaymentAddress {
  ...
  ///  oneof Address {
  var mobileCoinAddress: SignalServiceProtos_PaymentAddress.MobileCoinAddress {
    get {return _mobileCoinAddress ?? SignalServiceProtos_PaymentAddress.MobileCoinAddress()}
    set {_mobileCoinAddress = newValue}
  }
  /// Returns true if `mobileCoinAddress` has been explicitly set.
  var hasMobileCoinAddress: Bool {return self._mobileCoinAddress != nil}
  /// Clears the value of `mobileCoinAddress`. Subsequent reads from it will return its default value.
  mutating func clearMobileCoinAddress() {self._mobileCoinAddress = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  struct MobileCoinAddress {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    var address: Data {
      get {return _address ?? Data()}
  ...
  fileprivate var _mobileCoinAddress: SignalServiceProtos_PaymentAddress.MobileCoinAddress? = nil
}
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8: try { try decoder.decodeSingularBoolField(value: &_storage._multiRing) }()
  ...
  static func ==(lhs: SignalServiceProtos_CallMessage, rhs: SignalServiceProtos_CallMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._multiRing != rhs_storage._multiRing {return false}
...
extension SignalServiceProtos_DataMessage.Reaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "emoji"),
    2: .same(proto: "remove"),
    4: .same(proto: "targetAuthorUuid"),
    5: .same(proto: "targetSentTimestamp"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self._targetAuthorUuid) }()
      case 5: try { try decoder.decodeSingularUInt64Field(value: &self._targetSentTimestamp) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._targetAuthorUuid {
      try visitor.visitSingularStringField(value: v, fieldNumber: 4)
    }
  ...
  static func ==(lhs: SignalServiceProtos_DataMessage.Reaction, rhs: SignalServiceProtos_DataMessage.Reaction) -> Bool {
    ...
    if lhs._targetAuthorUuid != rhs._targetAuthorUuid {return false}
...
extension SignalServiceProtos_SyncMessage.Contacts: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self._complete) }()
      default: break
      }
    }
  }
...
extension SignalServiceProtos_ContactDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeSingularStringField(value: &self._uuid) }()
...
extension SignalServiceProtos_PaymentAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "mobileCoinAddress"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._mobileCoinAddress) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._mobileCoinAddress {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: SignalServiceProtos_PaymentAddress, rhs: SignalServiceProtos_PaymentAddress) -> Bool {
    if lhs._mobileCoinAddress != rhs._mobileCoinAddress {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension SignalServiceProtos_PaymentAddress.MobileCoinAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SignalServiceProtos_PaymentAddress.protoMessageName + ".MobileCoinAddress"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: SignalServiceProtos_PaymentAddress.MobileCoinAddress, rhs: SignalServiceProtos_PaymentAddress.MobileCoinAddress) -> Bool {
