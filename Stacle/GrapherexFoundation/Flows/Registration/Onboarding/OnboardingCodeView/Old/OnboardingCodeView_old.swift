...
private protocol OnboardingCodeViewTextFieldDelegate_old: AnyObject {
...
// digit.
private class OnboardingCodeViewTextField_old: UITextField {

    fileprivate weak var codeDelegate: OnboardingCodeViewTextFieldDelegate_old?
...
protocol OnboardingCodeViewDelegate_old: AnyObject {
...
// last/next digit.
final class OnboardingCodeView_old: UIView {

    weak var delegate: OnboardingCodeViewDelegate_old?
    ...
    fileprivate let textfield = OnboardingCodeViewTextField_old()
...
extension OnboardingCodeView_old: UITextFieldDelegate {
...
extension OnboardingCodeView_old: OnboardingCodeViewTextFieldDelegate_old {
