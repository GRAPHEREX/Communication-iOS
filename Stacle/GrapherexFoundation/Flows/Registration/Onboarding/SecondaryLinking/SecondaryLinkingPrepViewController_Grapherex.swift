...
@objc
public class SecondaryLinkingPrepViewController_Grapherex: OnboardingBaseViewController_Grapherex {

    let provisioningController: ProvisioningController_Grapherex
    let animationView = AnimationView(name: "launchApp")

    public init(provisioningController: ProvisioningController_Grapherex) {
