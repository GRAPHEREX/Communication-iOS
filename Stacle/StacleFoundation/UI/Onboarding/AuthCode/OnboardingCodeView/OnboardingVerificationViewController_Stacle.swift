...
@objc
public class OnboardingVerificationViewController_Stacle: OWSViewController {
    ...
    // MARK: -
    @objc public var onboardingController: OnboardingController_Stacle!
    ...
    @IBOutlet var onboardingCodeView: OnboardingCodeView_Stacle!
...
extension OnboardingVerificationViewController_Stacle: OnboardingCodeViewDelegate {
