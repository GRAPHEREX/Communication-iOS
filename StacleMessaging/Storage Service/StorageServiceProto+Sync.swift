...
extension StorageServiceProtoAccountRecord: Dependencies {
    ...
    func mergeWithLocalAccount(transaction: SDSAnyWriteTransaction) -> MergeState {
        ...
        let credentials = profileManagerImpl.profileAvatarCredentials(for: localAddress, transaction: transaction)
        let bucket = profileManagerImpl.profileAvatarBucket(for: localAddress, transaction: transaction)
