...
public protocol MoneyFormatting {
...
public protocol MoneyAdjusting {
...
public class MoneyFormatter: MoneyFormatting {
    ...
    public var minDecimalDigits: Int {
        set {
    ...
    public typealias InitHandler = ((MoneyFormatter) -> (Void))
...
extension MoneyFormatter: MoneyAdjusting {
