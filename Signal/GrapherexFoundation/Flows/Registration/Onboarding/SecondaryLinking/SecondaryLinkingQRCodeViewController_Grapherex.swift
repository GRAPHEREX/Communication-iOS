...
@objc
public class SecondaryLinkingQRCodeViewController_Grapherex: OnboardingBaseViewController_Grapherex {

    let provisioningController: ProvisioningController_Grapherex

    required init(provisioningController: ProvisioningController_Grapherex) {
