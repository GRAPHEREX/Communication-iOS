...
@objc
public class OnboardingNavigationController_Stacle: OWSNavigationController {
    let onboardingController: OnboardingController_Stacle

    @objc
    public init(onboardingController: OnboardingController_Stacle) {
...
@objc
public class OnboardingController_Stacle: NSObject {
    ...
    public var isOnboardingModeOverriden: Bool {
        return onboardingMode != OnboardingController_Stacle.defaultOnboardingMode
    }
    ...
    convenience override init() {
        let onboardingMode = OnboardingController_Stacle.ascertainOnboardingMode()
    ...
    fileprivate func nextViewController(milestone: OnboardingMilestone) -> UIViewController {
        ...
        case .verifiedPhoneNumber, .verifiedLinkedDevice:
            return OnboardingSplashViewController_Stacle(onboardingController: self)
        case .setupProfile:
            return buildProfileRegistartionViewController()
        case .restorePin:
            return Onboarding2FAViewController_Stacle(onboardingController: self, isUsingKBS: true)
        case .setupPin:
...
//        } else {
            let view = UIStoryboard.makeController(OnboardingPhoneNumberViewController_Stacle.self)
...
//        }
    ...
    public func requestingVerificationDidSucceed(viewController: UIViewController) {
        ...
        if !(viewController.navigationController?.topViewController is OnboardingVerificationViewController) {
            let view = UIStoryboard.makeController(OnboardingVerificationViewController_Stacle.self)
            view.onboardingController = self
            viewController.navigationController?.pushViewController(view, animated: true)
        }
    }
...
//        navigationController.pushViewController(view, animated: true)
    ...
    public func onboardingDidRequire2FAPin(viewController: UIViewController) {
        ...
        let view = Onboarding2FAViewController_Stacle(onboardingController: self, isUsingKBS: kbsAuth != nil)
        navigationController.pushViewController(view, animated: true)
    }
    ...
    public func requestVerification(fromViewController: UIViewController, isSMS: Bool) {
        ...
        OnboardingController_Stacle.setLastRegisteredCountryCode(value: countryState.countryCode)
        OnboardingController_Stacle.setLastRegisteredPhoneNumber(value: phoneNumber.userInput)
