...
@objc
public class Onboarding2FAViewController_Stacle: OnboardingBaseViewController_Stacle {
    ...
    public init(onboardingController: OnboardingController_Stacle, isUsingKBS: Bool) {
    ...
    private func showAttemptsExhausted() {
        ...
        let vc = OnboardingPinAttemptsExhaustedViewController_Stacle(onboardingController: onboardingController)
...
extension Onboarding2FAViewController_Stacle: UITextFieldDelegate {
