...
final class TransactionCell: NiblessView {
    ...
    private let transactionLabel: UILabel = {
        ...
        label.font = .wlt_sfUiTextRegularFont(withSize: 14)
    ...
    private let rateLabel: UILabel = {
        let label = UILabel()
        label.font = .wlt_sfUiTextRegularFont(withSize: 12)
    ...
    func setup() {
        ...
        indicatorView.tintColor = Theme.inversedBackgroundColor
...
internal extension TransactionCell {
    func render() {
