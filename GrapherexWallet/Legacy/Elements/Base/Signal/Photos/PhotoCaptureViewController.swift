...
//class PhotoCaptureViewController: WLTViewController, InteractiveDismissDelegate {
//
...
//        self.view = UIView()
//        self.view.backgroundColor = UIColor.white // MARK: - SINGAL DEPENDENCY - THEME  = Theme.darkThemeBackgroundColor
...
//            captureButton.wltAutoVCenterInSuperview()
...
//        } else {
//            captureButton.wltAutoHCenterInSuperview()
...
//        topBar.wltAutoPinWidthToSuperview()
...
//            self.button = OWSButton(imageName: imageName, tintColor: .wlt_white, block: block)
//            button.wltSetCompressionResistanceHigh()
...
//
//    let defaultDiameter: CGFloat = min(WLTWLTScaleFromIPhone5To7Plus(60, 80), 80)
//    static let recordingDiameter: CGFloat = min(WLTWLTScaleFromIPhone5To7Plus(68, 120), 120)
...
//        innerButton.backgroundColor = UIColor.wlt_white.withAlphaComponent(0.33)
...
//        zoomIndicator.layer.borderColor = UIColor.wlt_white.cgColor
...
//        let label = UILabel()
//        label.font = UIFont.wlt_monospacedDigitFont(withSize: 20)
...
//        stopButton.wltAutoVCenterInSuperview()
//        stopButton.alpha = 0
//
//        addSubview(highlightView)
//        highlightView.wltAutoVCenterInSuperview()
//        highlightView.alpha = 0
//
//        addSubview(lockIconView)
//        lockIconView.wltAutoVCenterInSuperview()
//
