...
CG_INLINE CGFloat WLTCGFloatClamp(CGFloat value, CGFloat minValue, CGFloat maxValue)
{
    return MAX(minValue, MIN(maxValue, value));
}

CG_INLINE CGFloat WLTCGFloatClamp01(CGFloat value)
{
    return WLTCGFloatClamp(value, 0.f, 1.f);
}

CG_INLINE CGFloat WLTCGFloatLerp(CGFloat left, CGFloat right, CGFloat alpha)
{
    return (left * (1.f - alpha)) + (right * alpha);
}

CG_INLINE CGFloat WLTCGFloatInverseLerp(CGFloat value, CGFloat minValue, CGFloat maxValue)
{
...
//}
//
CG_INLINE CGPoint WLTCGPointAdd(CGPoint left, CGPoint right)
{
    return CGPointMake(left.x + right.x, left.y + right.y);
}

CG_INLINE CGPoint WLTCGPointSubtract(CGPoint left, CGPoint right)
{
    return CGPointMake(left.x - right.x, left.y - right.y);
}
//
