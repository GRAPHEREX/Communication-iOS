...
@protocol WLTNavigationView <NSObject>
...
// unsaved changes.
@interface WLTNavigationController : UINavigationController
...
@property (nonatomic, nullable) NSNumber *wlt_prefersStatusBarHidden;
